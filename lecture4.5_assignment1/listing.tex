...
\title{Number Series Assignment}
\author{Christian Bager Bach Houmann}
\begin{document}
\maketitle
\lstinputlisting[style=colorBash,caption={CMakeLists.txt}]{./CMakeLists.txt}
\lstinputlisting[style=colorC++,caption={series\_wrapper.h}]{./series_wrapper.h}
\lstinputlisting[style=colorC++,caption={number\_series.h}]{./number_series.h}
\lstinputlisting[style=colorC++,caption={series\_wrapper.cpp}]{./series_wrapper.cpp}
